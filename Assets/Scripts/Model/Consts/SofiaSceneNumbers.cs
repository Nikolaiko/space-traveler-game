public class SofiaSceneNumbers
{
    public static int MAIN_SCENE_ID = 12;
    public static int STORY_SCENE_ID = 13;
    ...
    public static int SELECT_PLANET_SCENE_ID = 14;
    public static int BYPASS_HACKING_SCENE_ID = 10;
    public static int BYPASS_SCHEME_PAIRS_SCENE_ID = 11;
